            ...
            <v-col cols="12" sm="3" md="3">
                <v-card max-width="250" elevation="24">
                    <v-card-text>
                        ...
                        <br />
                        Permite el ingreso de la bitácora de calidad de los
                        tanqueros
                    </v-card-text>
                    <v-divider></v-divider>
                    <v-card-actions>
                        <router-link to="/modulos/flota/transporte">
                            <v-chip color="success"  active>Ingresar</v-chip>
                        </router-link>
                    </v-card-actions>
                </v-card>
            </v-col>
                ...
                <v-card max-width="250" elevation="24">
                    <v-card-text>
                        <v-btn color="orange" height="auto" class="outlined">
                            <v-icon size="80"> mdi-gas-station </v-icon>
                        </v-btn>
                        <br />
                        Permite el ingreso del mantenimiento de los surtidores.
                    </v-card-text>
                    <v-divider></v-divider>

                    <v-card-actions>
                        <router-link to="">
                            <v-chip color="orange">Ingresar</v-chip>
                        </router-link>
                    </v-card-actions>
                </v-card>
